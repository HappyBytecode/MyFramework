...
import static com.lirui.lib_common.view.web.WebUtils.hasJellyBeanMR1;
...
public class SafeManager {
    ...
    public SafeManager(WebView webView) {
     ...
     */
    @SuppressLint("NewApi")
    public boolean removeUnSafeJavascriptImpl() {
        if (WebUtils.hasHoneycomb() && !WebUtils.hasJellyBeanMR1()) {
