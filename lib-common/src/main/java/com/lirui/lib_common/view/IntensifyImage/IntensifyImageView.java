...
public class IntensifyImageView extends View implements IntensifyImage,
    ...
    private static final float MAX_VALUE = 3;//缩放的最大倍数
    ...
    protected void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDelegate.setMinimumScale(
                a.getFloat(R.styleable.IntensifyImageView_minimumScale, -1f));

        mDelegate.setMaximumScale(
                a.getFloat(R.styleable.IntensifyImageView_maximumScale, MAX_VALUE));
    ...
    public IntensifyImageDelegate.State getState() {
